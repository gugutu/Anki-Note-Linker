...
| --- | --- | --- |
| 复制笔记 ID | `Alt+Shift+C` | `Command+Option+C` |
| 复制笔记链接 | `Alt+Shift+L` | `Command+Option+L` |
| 插入带有已复制笔记 ID 的链接 | `Alt+Shift+V` | `Command+Option+V` |
| 插入新链接 | `Alt+Shift+N` | `Command+Option+N` |
| 插入链接模板 | `Alt+Shift+T` | `Command+Option+T` |
| 在新窗口中打开当前笔记 | `Alt+Shift+W` | `Command+Option+W` |

已有用户会保留当前快捷键设置。在 macOS 上，Anki/Qt 的快捷键配置中可能会将 Command+Option 显示为 Ctrl+Alt。

#### 复制笔记ID

使用右键菜单或默认快捷键复制编辑器中当前笔记的 ID

#### 复制笔记链接

使用右键菜单或默认快捷键复制编辑器中当前笔记的链接

#### 插入带有已复制的笔记ID的链接

使用右键菜单或默认快捷键从剪贴板中的笔记 ID 和当前选定的文本生成链接

#### 插入新链接（用于添加笔记）

使用右键菜单或默认快捷键从当前选定的文本生成新链接

双击生成的链接文本可以添加相应的新笔记

#### 插入链接模板

使用右键菜单或默认快捷键从当前选定的文本生成链接模板
